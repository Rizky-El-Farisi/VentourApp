...
public class Doa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.doa_web);
        webView.setWebViewClient(new WebViewClient());
        webView.getSettings().setJavaScriptEnabled(true);
        webView.loadUrl("https://dewanggaumroh.com/ini-dia-kumpulan-doa-doa-saat-beribadah-umroh-lengkapini-dia-doa-doa-saat-beribadah-umroh/");


//        PDFView pdfView = findViewById(R.id.pdf_doa);
//
//        pdfView.fromAsset("doa umroh.pdf").load();
